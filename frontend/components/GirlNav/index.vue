    ...
    <no-ssr>
      <div class="container">
        <ul>
          <li>
            <router-link
              :to="localePath({name: 'profile-id', params: {id: current_girl.id}})"
              :active="isCurrentPath('/profile/'+current_girl.id)"
            >
          ...
          <li>
            <router-link
              :to="localePath({name: 'profile-id-photos', params: {id: current_girl.id}})"
              :class="{inactive: !profileIsFilled, animated: profileIsFilled && !photosIsFilled}"
              :active="isCurrentPath('/profile/'+current_girl.id+'/photos')"
          ...
          <li>
            <router-link
              :to="localePath({name: 'profile-id-validate', params: {id: current_girl.id}})"
              :class="{inactive: !profileIsFilled || !photosIsFilled, animated: photosIsFilled && !profileIsVerified}"
              :active="isCurrentPath('/profile/'+current_girl.id+'/validate')"
          ...
          <li v-show="loggedUser.role == 'admin'">
            <router-link
              :to="localePath({name: 'profile-id-vip', params: {id: current_girl.id}})"
              :class="{inactive: !profileIsFilled || !photosIsFilled, animated: photosIsFilled && !profileIsVerified}"
              :active="isCurrentPath('/profile/'+current_girl.id+'/vip')"
              :disabled="!photosIsFilled || !profileIsFilled"
            >
              <!--<div class="step-number" v-if="!profileIsVerified">3</div>-->
              {{ $t('profile_nav.vip') }}
       ...
       <!--
        <b-nav pills class="profile-nav">
          <b-nav-item :to="localePath({name: 'profile-id', params: {id: current_girl.id}})"
                      :active="isCurrentPath('/profile/'+current_girl.id)">
            <div class="step-number" v-if="!profileIsVerified">1</div>
          ...
          <b-nav-item :to="localePath({name: 'profile-id-photos', params: {id: current_girl.id}})"
                      :class="{inactive: !profileIsFilled, animated: profileIsFilled && !photosIsFilled}"
                      :active="isCurrentPath('/profile/'+current_girl.id+'/photos')"
                      :disabled="!profileIsFilled">
            <div class="step-number" v-if="!profileIsVerified">2</div>
          ...
          <b-nav-item :to="localePath({name: 'profile-id-validate', params: {id: current_girl.id}})"
                      :class="{inactive: !profileIsFilled || !photosIsFilled, animated: photosIsFilled && !profileIsVerified}"
                      :active="isCurrentPath('/profile/'+current_girl.id+'/validate')"
                      :disabled="!photosIsFilled || !profileIsFilled">
            <div class="step-number" v-if="!profileIsVerified">3</div>
